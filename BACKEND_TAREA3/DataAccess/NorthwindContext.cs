...
namespace BACKEND_TAREA3.DataAccess
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Anual> Anuals { get; set; }
        public virtual DbSet<CantAnual> CantAnuals { get; set; }
        ...
        public virtual DbSet<CustomersAmerica> CustomersAmericas { get; set; }
        public virtual DbSet<Detalle> Detalles { get; set; }
        public virtual DbSet<Employee> Employees { get; set; }
        public virtual DbSet<EmployeeTerritory> EmployeeTerritories { get; set; }
        public virtual DbSet<Invoice> Invoices { get; set; }
        public virtual DbSet<MontoVentum> MontoVenta { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-L7EP1NA;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Anual>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<CantAnual>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CANT_ANUAL");
            ...
            modelBuilder.Entity<CustomersAmerica>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CUSTOMERS_AMERICA");
            ...
            modelBuilder.Entity<MontoVentum>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("MONTO_VENTA");
            ...
            modelBuilder.Entity<Paise>(entity =>
            {
                ...
                entity.ToView("PAISES");

                entity.Property(e => e.CantCustumers).HasColumnName("Cant_Custumers");
